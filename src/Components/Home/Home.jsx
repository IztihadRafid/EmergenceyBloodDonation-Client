           ...
           <div className='grid lg:grid-cols-2 gap-10 m-10  ' >
                <div className="card bg-base-100 image-full hover:opacity-90 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p>Before donating blood, ensure you meet the eligibility criteria, such as being in good health, having the required hemoglobin levels, and passing the necessary medical screenings. Always consult with a healthcare professional if unsure. </p>
                ...
                <div className="card bg-base-100 image-full hover:opacity-90 shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <p> Have questions about blood donation? Find answers to common concerns, donor eligibility, and the process of donating blood.</p>
                        <div className="card-actions justify-end">
                        <div className="card-actions justify-end">
