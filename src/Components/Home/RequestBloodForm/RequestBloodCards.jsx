...
const RequestBloodCards = () => {
    ...
    // Filter requests based on selected blood groups
    //By default show all requests card
    // Filter requests based on selected blood groups and district
    const filteredRequests = requestBlood.filter(donor => {
    ...
    // Display limited or full filtered requests based on "showAll" state
    const RequestsToDisplay = showAll ? filteredRequests : filteredRequests.slice(0, 4);
    return (
        //    
        <div >
            <Navbar></Navbar>
            ...
            <div className='lg:w-[90%] mx-auto lg:flex '>
                <div className="lg:w-1/4 mt-8">
                    <div className="card  mx-auto lg:mx-0 w-80 bg-red-100 ">
                ...
                <div className="w-3/4 h-fit mt-8 mx-auto grid lg:grid-cols-2 gap-8 ">
                    {
                        RequestsToDisplay.map(requestBlood => <RequestPatientCard key={requestBlood._id} requestBlood={requestBlood} ></RequestPatientCard>)
                    }
                </div>
            </div>
            {/* Show "See All" button only if not showing all requests */}
            {!showAll && (
