...
const DonorForm = () => {
    ...
    const handleDonorInfoForm = (event) => {
        ...
        const donorInformation = { name, patientName, gender, age, email, contactNumber, bloodGroup, occupation, presentAddress, division, district, guardian, relation, guardianContact,photo }
